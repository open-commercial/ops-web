...
@Component({
  selector: 'app-venta-anual-chart',
  templateUrl: './venta-anual-chart.component.html',
  styleUrls: ['./venta-anual-chart.component.scss']
})
export class VentaAnualChartComponent extends BarChartDirective implements OnInit {
