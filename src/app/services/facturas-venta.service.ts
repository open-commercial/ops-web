...
export class FacturasVentaService {
  ...
  static createBusquedaFacturaVentaCriteriaObject(terminos: any = {}, page = 0): BusquedaFacturaVentaCriteria {
    return {
  ...
  buscar(terminos: any = {}, pagina: number = 0): Observable<Pagination> {
    const criteria = FacturasVentaService.createBusquedaFacturaVentaCriteriaObject(terminos);
